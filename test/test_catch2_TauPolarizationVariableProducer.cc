...
static constexpr auto s_tag = "[TauPolarizationVariableProducer]";

TEST_CASE("Standard checks of TauPolarizationVariableProducer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TauPolarizationVariableProducer"
